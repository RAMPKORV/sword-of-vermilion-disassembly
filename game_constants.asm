; ======================================================================
; game_constants.asm
; Game logic constants: script opcodes, state machine IDs, item/magic/
; equipment IDs, entity struct offsets, and all other game constants.
; ======================================================================
...
Text_build_buffer       = $FFFFC260   ; buf  scratch buffer for assembling formatted text strings before display
...
Sound_queue_buffer          = $FFFFC322   ; buf  ring buffer of pending sound/music command bytes (up to 4 entries)
...
HScroll_run_table            = $FFFFC3B8   ; buf  per-line HScroll values (run-length table); written by scroll routines
VDP_regs_cache              = $FFFFC3F0   ; buf  shadow copy of all VDP register words (16 words, R0-R15)
...
Possessed_items_list        = $FFFFC444   ; arr  .b[20] item ID array (up to 20 items); length in Possessed_items_length
...
Possessed_magics_list       = $FFFFC464   ; arr  .b[30] magic ID array (up to 30 spells); length in Possessed_magics_length
Possessed_equipment_length  = $FFFFC482   ; .w
Possessed_equipment_list    = $FFFFC484   ; arr  .b[14] equipment ID array (up to 14 items); length in Possessed_equipment_length
...
Shop_item_list               = $FFFFC4B4   ; arr  .b[16] current shop's item ID list (loaded at shop entry)
...
Ready_equipment_list        = $FFFFC4E8   ; arr  .b[24] equipment IDs available for readying in the equipment menu
...
Towns_visited                                   = $FFFFC508   ; arr  .b[16] visited flag per town (non-zero = visited); indexed by TOWN_xxx
...
Ending_player_name_buffer       = $FFFFC646   ; buf  .b[6] copy of player name used during the ending credit sequence
...
Transaction_amount_end          = $FFFFC65E   ; end  sentinel address marking end of transaction data block
...
Enemy_position_indices          = $FFFFC6A0   ; arr  .b[8] slot-to-screen-position mapping for battle enemy layout
...
Watling_villagers_asked_about_rings         = $FFFFC72A   ; .b
...
Bearwulf_weapon_reward_given                = $FFFFC769   ; .b
...
Thar_bronze_key_collected                   = $FFFFC780   ; .b
Thar_silver_key_collected                   = $FFFFC781   ; .b
Luther_gold_key_collected                   = $FFFFC782   ; .b
...
Royal_shield_chest_opened                   = $FFFFC787   ; .b
Money_chest_256_opened                      = $FFFFC788   ; .b
Herbs_chest_opened                          = $FFFFC789   ; .b
Herbs_chest_2_opened                        = $FFFFC78A   ; .b
Crimson_armor_chest_opened                  = $FFFFC78B   ; .b
Candle_chest_opened                         = $FFFFC78C   ; .b
Herbs_chest_3_opened                        = $FFFFC78D   ; .b
Money_chest_768_stow_opened                 = $FFFFC78E   ; .b
Dark_sword_chest_opened                     = $FFFFC78F   ; .b
Herbs_chest_4_opened                        = $FFFFC790   ; .b
Scale_armor_chest_opened                    = $FFFFC791   ; .b
Candle_chest_parma_opened                   = $FFFFC792   ; .b
Money_chest_768_opened                      = $FFFFC793   ; .b
Money_chest_1536_opened                     = $FFFFC794   ; .b
Candle_chest_2_opened                       = $FFFFC796   ; .b
Herbs_chest_watling_opened                  = $FFFFC797   ; .b
Wyclif_outskirts_chest_opened               = $FFFFC798   ; .b
Medicine_chest_opened                       = $FFFFC799   ; .b
Crimson_armor_reward_enabled                = $FFFFC79A   ; .b
Money_chest_768_b_opened                    = $FFFFC79B   ; .b
Herbs_chest_5_opened                        = $FFFFC79C   ; .b
Magic_shield_chest_opened                   = $FFFFC79D   ; .b
Money_chest_1792_opened                     = $FFFFC79E   ; .b
Large_shield_chest_opened                   = $FFFFC79F   ; .b
Metal_armor_chest_opened                    = $FFFFC7A0   ; .b
Money_chest_2128_opened                     = $FFFFC7A1   ; .b
Lantern_chest_opened                        = $FFFFC7A2   ; .b
Skeleton_armor_chest_opened                 = $FFFFC7A3   ; .b
Money_chest_8192_opened                     = $FFFFC7A4   ; .b
Money_chest_12288_opened                    = $FFFFC7A5   ; .b
Money_chest_8192_b_opened                   = $FFFFC7A6   ; .b
...
Candle_chest_3_opened                       = $FFFFC7AE   ; .b
Lantern_chest_2_opened                      = $FFFFC7AF   ; .b
Herbs_chest_6_opened                        = $FFFFC7B0   ; .b
Ruby_brooch_chest_opened                    = $FFFFC7B2   ; .b
Banshee_powder_chest_opened                 = $FFFFC7B3   ; .b
Money_chest_512_opened                      = $FFFFC7B4   ; .b
Money_chest_1280_opened                     = $FFFFC7B5   ; .b
Money_chest_1792_b_opened                   = $FFFFC7B6   ; .b
Money_chest_20480_opened                    = $FFFFC7B9   ; .b
Chest_5888_kims_opened                      = $FFFFC7BA   ; .b
Money_chest_864_opened                      = $FFFFC7BB   ; .b
Chest_9999_kims_opened                      = $FFFFC7BC   ; .b
Chest_sapphire_shield_opened                = $FFFFC7BD   ; .b
Chest_gnome_stone_opened                    = $FFFFC7BE   ; .b
Chest_gem_shield_opened                     = $FFFFC7BF   ; .b
...
Chest_256_kims_opened                       = $FFFFC7E0   ; .b
Chest_graphite_sword_opened                 = $FFFFC7E1   ; .b
Chest_grizzly_shield_opened                 = $FFFFC7E2   ; .b
Chest_critical_sword_opened                 = $FFFFC7E3   ; .b
Chest_emerald_armor_opened                  = $FFFFC7E4   ; .b
Chest_secret_armor_opened                   = $FFFFC7E6   ; .b
Chest_old_nick_armor_opened                 = $FFFFC7E7   ; .b
Chest_mirage_sword_opened                   = $FFFFC7E8   ; .b
Chest_phantom_shield_opened                 = $FFFFC7E9   ; .b
Chest_death_sword_opened                    = $FFFFC7EA   ; .b
Chest_4096_kims_opened                      = $FFFFC7EC   ; .b
Malaga_quest_progress                       = $FFFFC7ED   ; .b
Chest_mirror_of_atlas_opened                = $FFFFC7EE   ; .b
Chest_barbarian_sword_opened                = $FFFFC7EF   ; .b
...
Boss_battle_flags                           = $FFFFC800   ; buf  .b[32] boss-fight state flags; indices below
...
Carthahena_soldier_2_defeated               = $FFFFC81E   ; .b
Carthahena_soldier_3_defeated               = $FFFFC81F   ; .b
Map_trigger_flags           = $FFFFC820   ; arr  .b[~60] transient map/cutscene event trigger flags (not saved to SRAM)

; ------------------------------------------------------------
; Object/Entity System
; ------------------------------------------------------------
VBlank_object_ptr            = $FFFFCC00   ; .l  pointer to the VBlank object update routine (called each VBlank)
HBlank_object_ptr            = $FFFFCC04   ; .l  pointer to the HBlank object update routine (called each HBlank)
...
Menu_object_ptr              = $FFFFCC74   ; .l  pointer to the active menu/UI object update routine

; ------------------------------------------------------------
; Object RAM & Sprite Tables
; ------------------------------------------------------------
Object_slot_base             = $FFFFD000   ; buf  object/entity slot pool base (14 slots × $E0 bytes each)
Object_table_base            = $FFFFD0E0   ; buf  object table array base (entries reference slot pool)
Sprite_attr_count            = $FFFFE000   ; .w
Sprite_update_pending        = $FFFFE002   ; .b
Sprite_attr_buffer           = $FFFFE004   ; buf  unsorted OAM entries; each entry is 8 bytes (Y, size/link, tile, X)
Sprite_sort_buffer           = $FFFFE200   ; buf  intermediate sort workspace used by SortAndUploadSpriteOAM
Sprite_sort_temp_buffer      = $FFFFE3F0   ; buf  final sorted OAM list written by SortAndUploadSpriteOAM
Sprite_priority_slots        = $FFFFE400   ; arr  256 priority buckets × 16 bytes; used to sort sprites by draw order

; ------------------------------------------------------------
; Sound Driver
; ------------------------------------------------------------
Sound_driver_play           = $FFFFF404   ; .b
Ram_clear_end                = $FFFFFD00    ; end  sentinel: top of general RAM clear region (before stack gap at $FFFFFE00)
...
obj_hp_lo           equ $29   ; byte: low byte of obj_hp word (enemy HP, low byte only)

; EnemyAppearance struct field offsets (24-byte entries; see battledata.asm lines 72–95)
; Assembled by the enemyAppearance macro (macros.asm).  A6 points to the entry.
eagfx_main_gfx      equ $04   ; long: main body GFX data pointer
eagfx_dma_fn        equ $10   ; long: DMA routine pointer (NullSpriteRoutine-2 / ExecuteWorldMapDma)
eagfx_vfx           equ $14   ; long: packed $PPQQSSTT (PP=pal_hi, QQ=pal_lo, SS=sprite_size, TT=tile_id)
eagfx_vfx_pal_lo    equ $15   ; byte: palette low byte (QQ byte of vfx long, big-endian byte 1)
